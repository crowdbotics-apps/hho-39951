"""
Django settings for hho_39951 project.
...
WSGI_APPLICATION = 'hho_39951.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hho_39951 API",
    "DESCRIPTION": "API documentation for hho_39951 App",
    "VERSION": "v1",
}
